#!/bin/bash
# This script create a simple git's hook in order to commit PRIMETIME4U-client also on Google Code.
...
echo "exec git push --mirror https://code.google.com/p/primetime4u-client/" >> .git/hooks/post-commit
